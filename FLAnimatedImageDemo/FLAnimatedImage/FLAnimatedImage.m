...
- (instancetype)initWithAnimatedGIFData:(NSData *)data
{
    ...
    if (self) {
        ...
        if (animatedImageFrameSize * self.frameCount <= FLAnimatedImageDataSizeCategoryAll) {
            _frameCacheSizeOptimal = self.frameCount;
        } else if (animatedImageFrameSize * FLAnimatedImageFrameCacheSizeDefault <= FLAnimatedImageDataSizeCategoryDefault) {
