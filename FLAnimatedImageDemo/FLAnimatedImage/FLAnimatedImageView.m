...
- (void)displayDidRefresh:(CADisplayLink *)displayLink
{
    ...
    if (image) {
        ...
        float currentFrameDelay = [self.animatedImage delayTimeAtIndex:self.currentFrameIndex];
        while (self.accumulator >= currentFrameDelay) {
            self.accumulator -= currentFrameDelay;
